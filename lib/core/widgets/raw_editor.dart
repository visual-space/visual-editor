...
class RawEditorState extends EditorState
  ...
  ///
  /// Returns `false` if a buttons couldn't be shown, such as when the buttons
  /// is already shown, or when no text selection currently exists.
  @override
  bool showToolbar() {
    // Web is using native dom elements to enable clipboard functionality of the
    // buttons: copy, paste, select, cut. It might also provide additional
    // functionality depending on the browser (such as translate). Due to this
    // we should not show a Flutter buttons for the editable text elements.
    if (kIsWeb) {
      return false;
    }
