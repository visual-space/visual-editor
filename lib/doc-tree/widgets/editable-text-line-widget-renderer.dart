...
import 'editable-text-line-widget-leading-and-body.dart';

// Receives as a child a regular line of text composed from text spans.
...
class EditableTextLineWidgetRenderer extends RenderObjectWidget {
  ...
  RenderObjectElement createElement() {
    return EditableTextLineWidgetLeadingAndBody(this);
  }
