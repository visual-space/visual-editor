...
// The interface is usually implemented by textfield implementations wrapping VisualEditor,
// that use a TextSelectionGesturesBuilder to build a TextSelectionGestures for their VisualEditor.
...
abstract class TextSelectionGesturesBuilderDelegateM {
  // GlobalKey to the VisualEditor for which the TextSelectionGesturesBuilder will build a TextSelectionGestures.
  GlobalKey<EditorStateM> get editableTextKey;
