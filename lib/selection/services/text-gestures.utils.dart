...
class TextGesturesUtils {
  ...
  void onTapDown(TapDownDetails details) {
    ...
    _editorRendererState.renderer.handleTapDown(details);
  ...
  void onSingleTapUp(
    ...
    try {
          ...
          switch (details.kind) {
            ...
            case PointerDeviceKind.invertedStylus:
              ...
              if (_isShiftClick(details.kind)) {
                ...
                _editorRendererState.renderer.onSelectionCompleted();
              }
      ...
      _keyboardService.requestKeyboard(_rawEditorUtils);
    }
  }
  ...
  void onDragSelectionStart(DragStartDetails details) {
    _editorRendererState.renderer.handleDragStart(details);
  }
  ...
  void onDragSelectionUpdate(
    ...
    _editorRendererState.renderer.extendSelection(
  ...
  void onDragSelectionEnd(DragEndDetails details) {
    _editorRendererState.renderer.handleDragEnd(details);
  }
