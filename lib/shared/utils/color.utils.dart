...
Color stringToColor(String? string) {
  ...
  if (string!.startsWith('rgba')) {
    string = string.substring(5); // trim left 'rgba('
    string = string.substring(0, string.length - 1); // trim right ')'
    final arr = string.split(',').map((e) => e.trim()).toList();
