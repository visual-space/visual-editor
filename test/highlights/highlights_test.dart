...
void main() {
  ...
  group('Highlights', () {
    ...
    test('Adds multiple highlights, no overlap', () {
      editorController.updateSelection(
          TextSelection(baseOffset: 5, extentOffset: 10), ChangeSource.LOCAL);
      editorController.addHighlight(HighlightM(
          textSelection: TextSelection(baseOffset: 5, extentOffset: 10),
    ...
    test('Adds multiple highlights, overlap', () {
      editorController.updateSelection(
          TextSelection(baseOffset: 5, extentOffset: 10), ChangeSource.LOCAL);
      editorController.addHighlight(HighlightM(
    ...
    test(
        'Removes partial highlight inside highlight extent via selection range - case where two resultant highlights are required',
        () {
      final highlight = HighlightM(
    ...
    test(
      ...
      // NOTE this method in the HighlightsState class uses the same logic as the above, which manages the removal of highlights smaller than the full size of the
